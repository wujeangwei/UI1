...
public abstract class UniCarNaviConstant {
    ...
    public static final int VALUE_ROUTE_PLAN_AVOID_CONGESTION = 1;
    public static final int VALUE_ROUTE_PLAN_NO_HIGHWAY = 2;
    public static final int VALUE_ROUTE_PLAN_SAVE_MONEY = 3;
    public static final int VALUE_ROUTE_PLAN_HIGHWAY = 4;
