...
public class UniCarNaviGuiService extends Service {
    ...
    private void doReceivedCmd(Intent intent) {
        ...
        if (UniCarNaviConstant.ACTION_START_UNICARNAVI.equals(action)) {
            ...
            if (isPlayTTS) {
                TTSUtil.playTTS(mContext, mContext.getString(R.string.tts_exit_navi));
            }
            ...
            Logger.d(TAG, "doReceivedCmd-ACTION_SET_DISPLAY_MODE-displayMode : " + displayMode);
            ...
            Logger.d(TAG, "doReceivedCmd-ACTION_CONTROL_UNICARNAVI-operation : " + operation);
            ...
            int operation = intent.getIntExtra(UniCarNaviConstant.DATA_KEY_OPERATION, 0);
            Logger.d(TAG, "doReceivedCmd-ACTION_CONTROL_ROAD_CONDITION_SHOW-operation : "
                    + operation);
