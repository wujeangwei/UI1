                    ...
                    switch (buttonView.getId()) {
                        ...
                        case R.id.cb_float_mic:
                            ...
                            if (isChecked) {
                                ...
                                TTSUtil.playTTS(mContext, TTSUtil.TTS_SETTING_FLOAT_MIC_OPEN);
                            } else {
                                mTvFloatMicStatus.setText(R.string.setting_float_mic_closed);
                                TTSUtil.playTTS(mContext, TTSUtil.TTS_SETTING_FLOAT_MIC_CLOSE);
                            }
                ...
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    ...
                    switch (checkedId) {
                        case R.id.rBtn_map_gaode:
                            ...
                            TTSUtil.playTTS(mContext, TTSUtil.TTS_SETTING_MAP_AMAP);
                            break;
                        case R.id.rBtn_map_baidu:
                            ...
                            TTSUtil.playTTS(mContext, TTSUtil.TTS_SETTING_MAP_BAIDU);
                            break;
