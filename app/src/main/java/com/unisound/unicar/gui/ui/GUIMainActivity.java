...
public class GUIMainActivity extends Activity implements OnClickListener {
    ...
    private ImageView mIvConnectMobie;
    ...
    private void initMainHeadView() {
        ...
        mIvConnectMobie = (ImageView) findViewById(R.id.iv_connect_mobie);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.iv_edit_wakeupword:
                    ...
                    showEditWakeupwordPopWindow(mContext);
                    break;
                case R.id.iv_connect_mobie:
                    Logger.d(TAG, "iv_connect_mobie click");
                    Intent connectIntent =
                            new Intent(GUIMainActivity.this, MobileConnectionActivity.class);
