...
public class GuiProtocolUtil {
     ...
     * @return
     */
    public static String getSetTtsTimbreProtocol(String state, boolean isNeedPlayTTS) {
        if (isNeedPlayTTS) {
            return getSettingProtocolParam(state, SessionPreference.PARAM_TYPE_PLAY_TTS);
        } else {
            return getSettingProtocolParam(state, SessionPreference.PARAM_TYPE_NOT_PLAY_TTS);
        }
    }
